...
public class HystrixBuilderTest {
  ...
  public void hystrixCommand() {
    ...
    Assertions.assertThat(command.execute()).isEqualTo("foo");
  }
  ...
  public void hystrixCommandFallback() {
    ...
    Assertions.assertThat(command).isNotNull();
    Assertions.assertThat(command.execute()).isEqualTo("fallback");
  }
  ...
  public void hystrixCommandInt() {
    ...
    Assertions.assertThat(command).isNotNull();
    Assertions.assertThat(command.execute()).isEqualTo(new Integer(1));
  }
  ...
  public void hystrixCommandIntFallback() {
    ...
    Assertions.assertThat(command).isNotNull();
    Assertions.assertThat(command.execute()).isEqualTo(new Integer(0));
  }
  ...
  public void hystrixCommandList() {
    ...
    Assertions.assertThat(command).isNotNull();
    Assertions.assertThat(command.execute()).containsExactly("foo", "bar");
  }
  ...
  public void hystrixCommandListFallback() {
    ...
    Assertions.assertThat(command).isNotNull();
    Assertions.assertThat(command.execute()).containsExactly("fallback");
  }
  ...
  public void fallbacksApplyOnError() {
    ...
    Assertions.assertThat(result).containsExactly("stuarthendren");
  }
  ...
  public void rxObservable() {
    ...
    Assertions.assertThat(observable).isNotNull();
  ...
  public void rxObservableList() {
    ...
    observable.subscribe(testSubscriber);
    testSubscriber.awaitTerminalEvent();
    Assertions.assertThat(testSubscriber.getOnNextEvents().get(0)).containsExactly("foo", "bar");
  }
  ...
  public void rxObservableListFall() {
    ...
    observable.subscribe(testSubscriber);
    testSubscriber.awaitTerminalEvent();
    Assertions.assertThat(testSubscriber.getOnNextEvents().get(0)).containsExactly("fallback");
  }
  ...
  public void rxObservableListFall_noFallback() {
    ...
    Assertions.assertThat(testSubscriber.getOnNextEvents()).isEmpty();
    Assertions.assertThat(testSubscriber.getOnErrorEvents().get(0))
  ...
  public void rxCompletableEmptyBody() {
    ...
    Assertions.assertThat(completable).isNotNull();
    Assertions.assertThat(server.getRequestCount()).isEqualTo(0);
  ...
  public void plainStringFallback() {
    ...
    Assertions.assertThat(string).isEqualTo("fallback");
  }
  ...
  public void plainList() {
    ...
    Assertions.assertThat(list).isNotNull().containsExactly("foo", "bar");
  }
  ...
  public void plainListFallback() {
    ...
    Assertions.assertThat(list).isNotNull().containsExactly("fallback");
  }

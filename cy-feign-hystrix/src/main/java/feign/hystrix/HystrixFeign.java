...
public final class HystrixFeign {
  ...
  public static final class Builder extends Feign.Builder {
    ...
    private InvocationRuntimeSetterFactory invocationRuntimeSetterFactory = new InvocationRuntimeSetterFactory.Default();
    ...
    public Builder invocationRuntimeSetterFactory(InvocationRuntimeSetterFactory invocationRuntimeSetterFactory) {
    ...
    Feign build(final FallbackFactory<?> nullableFallbackFactory) {
      super.invocationHandlerFactory(new InvocationHandlerFactory() {
        @Override public InvocationHandler create(Target target,
          ...
          return new HystrixInvocationHandler(target, dispatch, setterFactory, nullableFallbackFactory, invocationRuntimeSetterFactory);
        }
      });
